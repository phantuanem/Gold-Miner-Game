...
class game {
    ...
    newGold() {
        ...
        time = 30;
        level ++;
        tager = (level + 1) * 500 + level * level * 120;
        this.initGold();
    }
    ...
    drawText() {
        this.context.drawImage(dolarIM, this.getWidth() / 3, this.getWidth() / 2, this.getWidth(), this.getWidth());
        this.context.fillStyle = "#68c912";
        if (this.score > tager)
            this.context.fillStyle = "gold";
        this.context.font = this.getWidth() + 'px Stencil';
        this.context.fillText(this.score, this.getWidth() * 1.5, this.getWidth() * 1.35);

        this.context.drawImage(targetIM, this.getWidth() / 3, this.getWidth() / 2 + this.getWidth(), this.getWidth(), this.getWidth());
        this.context.fillStyle = "#89f200";
        this.context.font = this.getWidth() + 'px Stencil';
